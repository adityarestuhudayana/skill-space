...
<head>
    ...
    <meta name="description" content="Dashboard Pembeli SkillSpace - Temukan freelancer dan jasa akademik terbaik dari mahasiswa berprestasi.">
...
<body class="has-sidebar">
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar__top">
            <!-- Logo -->
            <a href="index.php" class="sidebar__logo" id="sidebar-logo">
        ...
        <nav class="sidebar__nav">
            ...
            <ul class="sidebar__menu">
                <li>
                    <a href="index.php" class="sidebar__link sidebar__link--active" id="nav-beranda">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                        <span>Beranda</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="sidebar__link" id="nav-pesan">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
                        <span>Pesan</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="sidebar__link" id="nav-pesanan">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                        <span>Pesanan</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="sidebar__link" id="nav-keranjang">
            ...
            <ul class="sidebar__menu">
                <li>
                    <a href="#" class="sidebar__link" id="nav-saya">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                        <span>Saya</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="sidebar__link" id="nav-favorit">
                ...
                <li>
                    <a href="#" class="sidebar__link" id="nav-notifikasi">
            ...
            <section class="home-section" id="home-kategori">
                ...
                <div class="home-categories">
                    <a href="#" class="home-cat" id="hcat-desain">
                        <div class="home-cat__icon">
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><path d="M17.5 10.5a2.5 2.5 0 1 1 0 5"/><path d="M15 18a2.5 2.5 0 1 1-5 0"/><path d="M6.5 15.5a2.5 2.5 0 1 1 0-5"/><path d="M9 6a2.5 2.5 0 0 1 2-1"/><circle cx="12" cy="12" r="2"/></svg>
                        </div>
                        <span>Desain</span>
                    </a>
                    <a href="#" class="home-cat" id="hcat-les-privat">
                        <div class="home-cat__icon">
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><path d="M8 7h8"/><path d="M8 11h6"/></svg>
                        </div>
                    ...
                    <a href="#" class="home-cat" id="hcat-pengetikan">
                        <div class="home-cat__icon">
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M6 8h.01"/><path d="M10 8h.01"/><path d="M14 8h.01"/><path d="M18 8h.01"/><path d="M6 12h.01"/><path d="M10 12h.01"/><path d="M14 12h.01"/><path d="M18 12h.01"/><path d="M8 16h8"/></svg>
                        </div>
                    ...
                    <a href="#" class="home-cat" id="hcat-translate">
                        <div class="home-cat__icon">
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 8l6 6"/><path d="M4 14l6-6 2-3"/><path d="M2 5h12"/><path d="M7 2h1"/><path d="M22 22l-5-10-5 10"/><path d="M14 18h6"/></svg>
                        </div>
                        <span>Translate</span>
                    </a>
                    <a href="#" class="home-cat" id="hcat-data">
                        <div class="home-cat__icon">
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="9" y1="21" x2="9" y2="9"/><line x1="15" y1="21" x2="15" y2="14"/><line x1="3" y1="9" x2="21" y2="9"/></svg>
                        </div>
                        <span>Data</span>
                    </a>
            ...
            <section class="home-section" id="home-freelancer">
                ...
                <div class="home-freelancers">
                    ...
                    <div class="home-fl-card" id="hfl-sagara">
                        <div class="home-fl-card__avatar">
                            <img src="../../assets/images/Ahmad Sulaiman.png" alt="Sagara Mahendra">
                        </div>
                        <div class="home-fl-card__info">
                            <div class="home-fl-card__top">
                                <div>
                                    <h3 class="home-fl-card__name">Sagara Mahendra</h3>
                                    <p class="home-fl-card__skill">Coding & Excel</p>
                                </div>
                                <span class="home-fl-card__badge">Tersedia</span>
                            </div>
                            <div class="home-fl-card__bottom">
                                <div class="home-fl-card__rating">
                                ...
                                <div class="home-fl-card__price">
                                    Mulai dari <strong>Rp 30.000</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="home-fl-card" id="hfl-xabiru">
                        ...
                        <div class="home-fl-card__info">
                            <div class="home-fl-card__top">
                                <div>
                                    <h3 class="home-fl-card__name">Xabiru Galaska</h3>
                                    <p class="home-fl-card__skill">Desain Poster</p>
                                </div>
                                <span class="home-fl-card__badge">Tersedia</span>
                            </div>
                            <div class="home-fl-card__bottom">
                                ...
                                <div class="home-fl-card__price">
                                    Mulai dari <strong>Rp 25.000</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="home-fl-card" id="hfl-carmenita">
                        ...
                        <div class="home-fl-card__info">
                            <div class="home-fl-card__top">
                                <div>
                                    <h3 class="home-fl-card__name">Carmenita</h3>
                                    <p class="home-fl-card__skill">Les Privat</p>
                                </div>
                            ...
                            <div class="home-fl-card__bottom">
                                ...
                                <div class="home-fl-card__price">
                                    Mulai dari <strong>Rp 50.000</strong>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="home-section" id="home-jasa">
                ...
                <div class="home-services">
                    ...
                    <div class="home-svc-card" id="hsvc-1">
                        <div class="home-svc-card__thumb">
                        ...
                        <div class="home-svc-card__info">
                            ...
                            <div class="home-svc-card__footer">
                                ...
                                <div class="home-svc-card__rating">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="#FBBF24" stroke="#FBBF24" stroke-width="1"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
                                    <span>4.9</span>
                                </div>
                            </div>
    ...
    <nav class="bottom-nav" id="bottom-nav">
        <a href="index.php" class="bottom-nav__item bottom-nav__item--active" id="bnav-beranda">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
            <span>Beranda</span>
        </a>
        <a href="#" class="bottom-nav__item" id="bnav-pesan">
